...
function addToInput(value) {
    var input = document.getElementById('input'); // Получаем элемент ввода по ID 'input' и приводим его к типу HTMLInputElement
    input.value += value; // Добавляем новое значение (число или оператор) к текущему значению строки
}
// Функция для очистки ввода
function clearInput() {
    var input = document.getElementById('input'); // Получаем элемент ввода по ID 'input'
...
function calculate() {
    var input = document.getElementById('input'); // Получаем элемент ввода по ID 'input'
    var result = evaluateExpression(input.value); // Передаем текущее выражение в поле ввода в функцию evaluateExpression для вычисления
...
function squareRoot() {
    var input = document.getElementById('input'); // Получаем элемент ввода по ID 'input'
    var value = parseFloat(input.value); // Преобразуем строку ввода в число с плавающей точкой
